...
class HistoryDetails extends StatelessWidget {
  final LeaveListModel? object;
  HistoryDetails({super.key, this.object});
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Center(
                            child: leaveController.user[0].photoUrl == null ||
                                    leaveController.user[0].photoUrl == ""
                                ? CircleAvatar(
                        ...
                        Padding(
                          ...
                          child: Text(
                            "${leaveController.user[0].firstName} ${leaveController.user[0].lastName}",
                            style: Theme.of(context).textTheme.titleMedium,
                          ),
                        ),
                        Padding(
                          ...
                          child: Text(
                            "${leaveController.user[0].email}",
                            style: Theme.of(context).textTheme.bodyMedium,
                          ),
                        ),
                        leaveController.user[0].phoneNumber != null
                            ? Padding(
                                padding: EdgeInsets.only(bottom: 0.h, top: 0.h),
                                child: Text(
                                  "${leaveController.user[0].phoneNumber}",
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                              )
                            : SizedBox(),
                        ...
                        //  object!.status =="Pending"?   SizedBox(
                        //       width: double.infinity,
                        //       child: Obx(
                        //          () {
                        //           return leaveController.isLoading.value == false ? Row(
                        //             mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        //             children: [
                        //               InkWell(
                        //                 onTap: () {
                        //                   leaveController.requestApprovelApiFrLeaveDetails(object!.id
                        //                       );
                        //                 },
                        //                 child: Container(
                        //                   height: 30.h,
                        ...
                        //               InkWell(
                        //                 onTap: () {
                        //                   leaveController.requestDeclineApiFrLeaveDetails(object!.id);
                        //                 },
                        //                 child: Container(
                        //                   height: 30.h,
                        //                   width: 70.w,
                        ...
                        //               )
                        //             ],
                        //           ):const Center(child: CircularProgressIndicator(color: ColorConstant.primaryDark,));
                        //         }
                        //       ),
