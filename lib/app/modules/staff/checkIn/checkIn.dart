...
import '../home/widgets/history.dart';

class CheckInViewStaff extends StatelessWidget {
  CheckInViewStaff({super.key});
  var homeManagerController = Get.put(StaffHomeController());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //       child: Center(
      //           child:
      //               Text("${homeManagerController.formatTime().toString()}")));
      // }),
      body: SafeArea(
        child: Obx(() {
  ...
  checkOutDialog(context, homeManagerController) async {
    await Get.dialog(
      AlertDialog(
